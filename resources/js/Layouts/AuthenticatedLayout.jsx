...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen">
            <SplineBackground />
            <nav className="relative z-50 isolate border-b border-white/20 bg-white/40 backdrop-blur-lg shadow-lg">
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-3 sm:-my-px sm:ms-10 sm:flex items-center">
                                <Link
                                    ...
                                    className={`relative px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 transform ${
                                        route().current('dashboard')
                                            ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg scale-105'
                                            : 'bg-white/60 backdrop-blur-md text-gray-700 hover:bg-white/80 hover:scale-105 border border-white/30'
                                    }`}
                                >
                                ...
                                <Link
                                    href={route('art-movements.index')}
                                    className={`relative px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 transform ${
                                        route().current('art-movements.*')
